...
If you are an owner and operator of your business you will need to wear many hats. These profiles for _educational purposes_ to help you to **put on the right hat** for each traditional business function so you can explore functionality in that context. In your organisation **you have complete control** to [configure roles exactly as you desire].
